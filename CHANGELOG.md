...
## [Unreleased] — corpus-driver load seam (version / PR-Snnn pinned at commit-prep; ADR-052 + ADR-102 amendments)

### Changed — corpus drivers RESUME BEFORE LOAD; every corpus-load loop is CI-gated (ADR-052 D13/D14/D15 amendment)
