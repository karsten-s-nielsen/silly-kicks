...
## [Unreleased] — TF-56 prescriptive defensive-positioning optimiser (commit-1; version / PR-Snnn / ADR pinned at commit-2, none pre-claimed)

### Added — `silly_kicks/positioning/` prescriptive positioning optimiser + measured `positioning_gap` (ADR-NNN)
