...
- ATT without GK: 0.0915 (SE 0.0071)
- ATT with GK:    0.0975 (SE 0.0070)
- GK ablation shift: 0.0061; placebo band p95 cluster (GATE): 0.0070; row (comparability): 0.0066
...
- SMD max pre/post: 0.881 / 0.070; **claim supported: True**
