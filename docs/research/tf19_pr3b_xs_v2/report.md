...
**Lock commit:** `78ffc70`   **Run commit:** `08ce9a86b0ea38ac2da600835ffdd71c1dfb651f`   (blindness: constants locked before the run; verify any intervening diff is inert)
...
- dose ladder (median |deltaxS| by ghost displacement): 2 m: 0.0139   3 m: 0.0171   4 m: 0.0187
- nearest_def control: 0.0049977414309978485   placebo_p95: 0.0   gated_band_median: n/a (unmeasurable)
- effect vs control ratio (2 m / nearest-def): 2.79x
...
- gated_band_n: 10180 (needs >= 100)   frames_used: 123430
- dose ladder (median |deltaxS| by ghost displacement): 2 m: 0.0139   3 m: 0.0171   4 m: 0.0187
- nearest_def control: 0.0049977414309978485   placebo_p95: 0.0006704537197947502   gated_band_median: 0.013937007635831833
- effect vs control ratio (2 m / nearest-def): 2.79x
- dose_response rho / p: 0.4128145941050255 / 0.001
