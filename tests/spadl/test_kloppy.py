...
from silly_kicks.data.opta import OptaLoader
from silly_kicks.data.statsbomb import StatsBombLoader
from silly_kicks.data.wyscout import PublicWyscoutLoader, WyscoutLoader
from silly_kicks.spadl import config as spadl
from silly_kicks.spadl import kloppy as kl
from silly_kicks.spadl import opta as spadl_opta
from silly_kicks.spadl import statsbomb as sb
from silly_kicks.spadl import wyscout as spadl_wyscout
...
def test_kloppy_to_actions_statsbomb(statsbomb_actions: Dataset, actiontype: str) -> None:
    ...
    # load statsbomb data using silly_kicks
    sel_actions_sa = statsbomb_actions.silly_kicks.loc[
        (statsbomb_actions.silly_kicks.type_id == spadl.actiontypes.index(actiontype)),
        cols,
    ]
...
def test_kloppy_to_actions_opta(opta_actions: Dataset, actiontype: str) -> None:
    ...
    # load statsbomb data using silly_kicks
    sel_actions_sa = opta_actions.silly_kicks.loc[
        (opta_actions.silly_kicks.type_id == spadl.actiontypes.index(actiontype)),
        cols,
    ]
    # load statsbomb data using kloppy
...
def test_kloppy_to_actions_wyscout(public_wyscout_actions: Dataset, actiontype: str) -> None:
    ...
    # load statsbomb data using silly_kicks
    sel_actions_sa = public_wyscout_actions.silly_kicks.loc[
        (public_wyscout_actions.silly_kicks.type_id == spadl.actiontypes.index(actiontype)),
        cols,
    ]
    # load statsbomb data using kloppy
