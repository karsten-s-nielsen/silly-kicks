...
def _df_two_attributed_passes_plus_null_team_row(
    *,
    ...
    rows = [
        _row(game_id=10502, event_id=1, possession_event_id=1, period_id=1, time_seconds=10.0,
             team_id=100, player_id=7, game_event_type="OTB", possession_event_type="PA",
             set_piece_type="O", ball_x=0.0, ball_y=0.0, pass_outcome_type="C", body_type="R"),
        _row(game_id=10502, event_id=2, possession_event_id=2, period_id=1, time_seconds=11.0,
             ...
             game_event_type="OTB", possession_event_type="PA",
             set_piece_type="O", ball_x=5.0, ball_y=2.0, pass_outcome_type="C", body_type="R"),
        _row(game_id=10502, event_id=3, possession_event_id=3, period_id=1, time_seconds=12.0,
             team_id=None, player_id=(None if null_player else null_player_id_value),
             game_event_type="OTB", possession_event_type="CH",
             set_piece_type=None, ball_x=10.0, ball_y=3.0, body_type="R"),
    ]
    df = pd.DataFrame(rows)
    for col in ("possession_event_id", "player_id", "team_id", "carry_defender_player_id",
                "challenger_player_id", "challenger_team_id", "challenge_winner_player_id",
                "challenge_winner_team_id"):
        df[col] = df[col].astype("Int64")
    df["game_id"] = df["game_id"].astype("int64")
    df["event_id"] = df["event_id"].astype("int64")
