...
import pytest
import silly_kicks.data.statsbomb as sb
from py.path import local
from pytest import fixture
from silly_kicks.data.base import ParseError
from silly_kicks.data.statsbomb import (
...
class TestWithoutStatsBombPy(unittest.TestCase):
    def setUp(self) -> None:
        ...
        reload(sys.modules["silly_kicks.data.statsbomb.loader"])
