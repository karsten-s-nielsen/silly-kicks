...
from silly_kicks.data.base import (
    EventDataLoader,
    ParseError,
    _expand_minute,
    _localloadjson,
...
class StatsBombLoader(EventDataLoader):
    ...
    def competitions(self) -> DataFrame[StatsBombCompetitionSchema]:
        ...
        pd.DataFrame
            ...
            :class:`~silly_kicks.spadl.statsbomb.StatsBombCompetitionSchema` for the schema.
        """
        cols = [
            "season_id",
            "competition_id",
    ...
    def games(self, competition_id: int, season_id: int) -> DataFrame[StatsBombGameSchema]:
        ...
        pd.DataFrame
            ...
            :class:`~silly_kicks.spadl.statsbomb.StatsBombGameSchema` for the schema.
        """
        cols = [
            "game_id",
            "season_id",
    ...
    def teams(self, game_id: int) -> DataFrame[StatsBombTeamSchema]:
        ...
        pd.DataFrame
            ...
            :class:`~silly_kicks.spadl.statsbomb.StatsBombTeamSchema` for the schema.
        """
    ...
    def players(self, game_id: int) -> DataFrame[StatsBombPlayerSchema]:
        ...
        pd.DataFrame
            ...
            :class:`~silly_kicks.spadl.statsbomb.StatsBombPlayerSchema` for the schema.
        """
        cols = [
            "game_id",
            "team_id",
    ...
    def events(self, game_id: int, load_360: bool = False) -> DataFrame[StatsBombEventSchema]:
        ...
        pd.DataFrame
            ...
            :class:`~silly_kicks.spadl.statsbomb.StatsBombEventSchema` for the schema.
        """
        cols = [
            "game_id",
            "event_id",
