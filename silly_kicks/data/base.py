...
class EventDataLoader(ABC):
    ...
    def competitions(self) -> DataFrame[Any]:
        ...
        pd.DataFrame
            ...
            :class:`~silly_kicks.spadl.base.CompetitionSchema` for the schema.
        """
    ...
    def games(self, competition_id: int, season_id: int) -> DataFrame[Any]:
        ...
        pd.DataFrame
            ...
            :class:`~silly_kicks.spadl.base.GameSchema` for the schema.
        """
    ...
    def teams(self, game_id: int) -> DataFrame[Any]:
        ...
        pd.DataFrame
            ...
            :class:`~silly_kicks.spadl.base.TeamSchema` for the schema.
        """
    ...
    def players(self, game_id: int) -> DataFrame[Any]:
        ...
        pd.DataFrame
            ...
            :class:`~silly_kicks.spadl.base.PlayerSchema` for the schema.
        """
    ...
    def events(self, game_id: int) -> DataFrame[Any]:
        ...
        pd.DataFrame
            ...
            :class:`~silly_kicks.spadl.base.EventSchema` for the schema.
        """
