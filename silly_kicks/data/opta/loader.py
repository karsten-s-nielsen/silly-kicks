...
from silly_kicks.data.base import EventDataLoader
...
class OptaLoader(EventDataLoader):
    ...
    parser : str or dict
        ...
        :class:`~silly_kicks.spadl.opta.OptaParser` and 'feed1_name' and
    ...
    def competitions(self) -> DataFrame[OptaCompetitionSchema]:
        ...
        pd.DataFrame
            ...
            :class:`~silly_kicks.spadl.opta.OptaCompetitionSchema` for the schema.
        """
    ...
    def games(self, competition_id: int, season_id: int) -> DataFrame[OptaGameSchema]:
        ...
        pd.DataFrame
            ...
            :class:`~silly_kicks.spadl.opta.OptaGameSchema` for the schema.
        """
        data: dict[int, dict[str, Any]] = {}
        for feed, feed_pattern in self.feeds.items():
    ...
    def teams(self, game_id: int) -> DataFrame[OptaTeamSchema]:
        ...
        pd.DataFrame
            ...
            :class:`~silly_kicks.spadl.opta.OptaTeamSchema` for the schema.
        """
        data: dict[int, dict[str, Any]] = {}
        for feed, feed_pattern in self.feeds.items():
    ...
    def players(self, game_id: int) -> DataFrame[OptaPlayerSchema]:
        ...
        pd.DataFrame
            ...
            :class:`~silly_kicks.spadl.opta.OptaPlayerSchema` for the schema.
        """
        data: dict[int, dict[str, Any]] = {}
        for feed, feed_pattern in self.feeds.items():
            glob_pattern = feed_pattern.format(competition_id="*", season_id="*", game_id=game_id)
    ...
    def events(self, game_id: int) -> DataFrame[OptaEventSchema]:
        ...
        pd.DataFrame
            ...
            :class:`~silly_kicks.spadl.opta.OptaEventSchema` for the schema.
        """
        data: dict[int, dict[str, Any]] = {}
        for feed, feed_pattern in self.feeds.items():
            glob_pattern = feed_pattern.format(competition_id="*", season_id="*", game_id=game_id)
